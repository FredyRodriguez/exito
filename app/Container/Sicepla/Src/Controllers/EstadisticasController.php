...
class EstadisticasController extends Controller
{
    ...
    public function index()
    {
        ...
        $chartDepar = Charts::database(Departamento::all(), 'pie', 'highcharts')
        ...
        $chartActi = Charts::database(Actividad::all(), 'area', 'highcharts')
            ...
            ->groupBy('nombre');
                ...
                return view('sicepla.super-admin.super-admin-estadistica',[
                        'chartUser' => $chartUser,
