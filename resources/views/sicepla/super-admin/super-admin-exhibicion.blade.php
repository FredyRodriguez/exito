...
@include('sicepla.alerts.errors')
    @component('components.portlet', ['icon' => 'fa fa-users', 'title' => 'Solicitar Producto en Exhibicion'])
        <div id="app">
        
        {!!Form::model($id, ['route' => ['bodega.update',$id], 'method' => 'PUT','files' => true, 'enctype'=>'multipart/form-data'])!!}
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group form-md-line-input"> 
                        {!!Form::label('CANTIDAD EN BODEGA')!!}                                
                        {!!Form::number('cantidadBodega',null,['id' => 'cantidadBodega' ,'class'=>'form-control','placeholder'=>'Cantidad Producto','required','readonly'=>'readonly'])!!}
                    </div>
                </div>
            </div>
            <div class="row">               
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group form-md-line-input">                                 
                        ...
                        {!!Form::number('precioProducto',null,['id' => 'precioProducto' ,'class'=>'form-control','placeholder'=>'Precio Compra al Proveedor','required','readonly'=>'readonly'])!!}
                    </div>
                </div>                         
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group form-md-line-input">                                 
                        {!!Form::label('CANTIDAD EN EXHIBICION')!!}                                
                        {!!Form::number('cantidadExhibicion',null,['id' => 'cantidadExhibicion' ,'class'=>'form-control','placeholder'=>'Precio Compra','required'])!!}
                    </div>
                </div></div>
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group form-md-line-input">                                 
                        ...
                        {!!Form::number('precioProductoComprar',null,['id' => 'precioProductoComprar' ,'class'=>'form-control','placeholder'=>'Precio Compra al Cliente','required'])!!}
                    </div>
                </div>
            </div>
                <div class="form-group form-md-line-input">
